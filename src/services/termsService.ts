...
const STATIC_TERMS: TermAndCondition[] = [
  ...
  },
  {
    ...
    "content": "In no event shall I, Satale Gayatri K, be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the service."
  },
  {
    "id": "prohibited",
  ...
  },
  {
    ...
    "content": "The Service and its original content, including but not limited to the design, text, graphics, project case studies, and logos, are the exclusive property of Satale Gayatri K and are protected by copyright and other intellectual property laws. My work may not be used in connection with any product or service without my prior written consent."
  }
];
